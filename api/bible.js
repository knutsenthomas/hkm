...
6. "extendedAnalysis": ${extended ? `Siden brukeren ba om en utvidet analyse (extended=true), må du skrive en grundig og dyptgående teologisk og bibelhistorisk analyse/essay om ordet på 300-600 ord. Bruk markdown for formatering (overskrifter som '### Historisk kontekst' eller '### Teologisk betydning', lister). VIKTIG: Bruk alltid '### Overskrift' for overskrifter. Vanlig brødtekst skal ALDRI pakkes inn i fet skrift (**tekst**). Fet skrift skal kun brukes på enkelte nøkkelord (1-3 ord) inne i setninger. Du må sette inn tydelige og ekte linjeskift (\n\n) før og etter hver overskrift og mellom hvert avsnitt.` : `Siden brukeren IKKE ba om utvidet analyse, må du sette dette feltet to nøyaktig en tom streng "".`}
