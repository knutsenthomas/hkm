        ...
        <div class="ms-overview-wrap">
            ...
            <div class="info-card ms-overview-card-gap" id="ov-prayer-preview-card" style="display: none;">
                <div class="info-card-header" style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <button class="btn btn-ghost btn-sm" onclick="window.minSideManager.loadView('prayer-wall')" style="font-size: 13px; display: inline-flex !important; align-items: center !important; justify-content: center !important; gap: 4px !important; padding: 6px 12px !important; height: 32px !important; border: none !important; width: auto !important;">
                        <span style="display: inline-flex; align-items: center; line-height: 1;">Gå til Bønneveggen</span><span class="material-symbols-outlined" style="font-size: 16px; display: inline-flex; align-items: center; justify-content: center; line-height: 1; transform: translateY(1.5px);">arrow_forward</span>
                    </button>
                </div>
                    ...
                    ovPrayerFeed.innerHTML = topPrayers.map(p => {
                        ...
                        return `
                            <div class="ov-prayer-item" style="border: 1px solid #e2e8f0; border-radius: 12px; padding: 12px 16px; background: #f8fafc; display: flex; flex-direction: column; justify-content: space-between; min-height: 110px;">
                                ...
                                <div style="display: inline-flex !important; align-items: center !important; gap: 4px !important; font-size: 11px; font-weight: 700; color: #bd4f2a; border-top: 1px solid #f1f5f9; padding-top: 8px; margin-top: auto; width: 100%; line-height: 1 !important;">
                                    <span class="material-symbols-outlined" style="font-size: 14px; display: inline-flex; align-items: center; justify-content: center; line-height: 1; transform: translateY(2px);">volunteer_activism</span><span style="display: inline-flex; align-items: center; line-height: 1;">${count} ber</span>
                                </div>
                            </div>
                        `;
                    }).join('');
