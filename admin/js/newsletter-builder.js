...
class NewsletterBuilder {
    ...
    openSocialInsertionFlowAt(afterElement) {
        ...
        document.getElementById('hkm-social-modal-insert').onclick = () => {
            ...
            const tileWebsite = `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1B4965" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>`;
            ...
            if (hasFB && hasIG && hasYT) {
                ...
                block.innerHTML = `
                    ...
                    <div style="display: flex; align-items: center; justify-content: center; gap: 14px; flex-wrap: wrap;">
                        ...
                        <a href="https://instagram.com/hiskingdomministry" target="_blank" title="Instagram" style="display: inline-flex; align-items: center; justify-content: center; width: 54px; height: 54px; border-radius: 16px; background: #ffffff; color: #1B4965; text-decoration: none; border: 1px solid #e2e8f0; box-shadow: 0 4px 10px rgba(0,0,0,0.06); transition: all 0.2s ease;">
                            ${tileIG}
                        </a>
