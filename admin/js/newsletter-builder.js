...
class NewsletterBuilder {
    ...
    openSocialInsertionFlowAt(afterElement) {
        ...
        document.getElementById('hkm-social-modal-insert').onclick = () => {
            ...
            const tileFB = `<svg width="22" height="22" viewBox="0 0 24 24" fill="#1877f2" style="width: 22px !important; height: 22px !important; max-width: 22px !important; max-height: 22px !important; display: block !important;"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>`;
            const tileIG = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#e4405f" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" style="width: 24px !important; height: 24px !important; max-width: 24px !important; max-height: 24px !important; display: block !important;"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>`;
            const tileYT = `<svg width="26" height="24" viewBox="0 0 24 24" fill="#ff0000" style="width: 26px !important; height: 24px !important; max-width: 26px !important; max-height: 24px !important; display: block !important;"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>`;
                ...
                linksHtml = `
                    ...
                    <div style="display: flex; align-items: center; justify-content: center; gap: 14px; flex-wrap: wrap;">
                        ${activePlatforms.map(p => `
                            <a href="${p.url}" target="_blank" title="${p.name}" style="display: inline-flex; align-items: center; justify-content: center; width: 54px; height: 54px; border-radius: 16px; background: #ffffff; color: ${p.color || '#1B4965'}; text-decoration: none; border: 1px solid #e2e8f0; box-shadow: 0 4px 10px rgba(0,0,0,0.06); transition: all 0.2s ease;">
    ...
    normalizeCanvasBlocks(container) {
        ...
        // Enforce strict dimensions on any existing social SVG icons inside container
        container.querySelectorAll('.newsletter-social-block svg').forEach(svg => {
    ...
    compileSocialBlockForEmail(block) {
        ...
        if (selectedStyle === 'text_only') {
            ...
            const tileFB = `<svg width="22" height="22" viewBox="0 0 24 24" fill="#1877f2" style="width: 22px !important; height: 22px !important; max-width: 22px !important; max-height: 22px !important; display: block !important; margin: 0 auto;"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>`;
            ...
            const tileYT = `<svg width="26" height="24" viewBox="0 0 24 24" fill="#ff0000" style="width: 26px !important; height: 24px !important; max-width: 26px !important; max-height: 24px !important; display: block !important; margin: 0 auto;"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>`;
            ...
            linksMarkup = platforms.map(platform => `
                <td align="center" valign="middle" style="padding: 4px 7px;">
                    <a href="${platform.href}" target="_blank" title="${platform.label}" aria-label="${platform.label}" style="display: inline-flex; align-items: center; justify-content: center; width: 54px; height: 54px; border: 1px solid #e2e8f0; border-radius: ${selectedStyle === 'icon_only' ? '50%' : '16px'}; background-color: #ffffff; color: ${platform.color}; text-align: center; text-decoration: none; box-shadow: 0 4px 10px rgba(0,0,0,0.06);">
